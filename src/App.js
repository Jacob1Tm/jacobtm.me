    ...
    <div className="App">
      ...
      <AppBar position="static">
        <Toolbar className={classes.foot}>
          <Typography variant="h6" className={classes.copyright}>Copyright © 2023 Jacob.Tm </Typography>
          <Button className={classes.buttonFooter} color="inherit" onClick={() => window.location.href = 'https://example.com'}>Source Code</Button>
        </Toolbar>
      </AppBar>
      </footer>
      </div>
